...
当前代码版本：`v0.0.8`（2026-07-22）。完整变更见 [CHANGELOG.md](CHANGELOG.md)。
...
4. 安装并启动 v0.0.8；程序会先备份旧数据库，再在事务中执行迁移。
5. 在主界面左下角确认显示 `v0.0.8`，再核对原有事项、号码和日志。
