import { CheckCircle2,Copy,ExternalLink,UserRound } from "lucide-react";
...
export default function AboutPanel({ version,onCopy }: Props) {
  return <section className="about-page">
    ...
    <div className="about-card"><img src="/inline-mark.svg" alt="In Line 图标"/><div><strong>In Line</strong><span>当前版本 v{version||"0.0.4"}</span></div></div>
    <dl className="about-details">
      ...
      <div><dt><CheckCircle2 size={17}/>软件版本</dt><dd>v{version||"0.0.4"}</dd></div>
    </dl>
